--[[ **ANNOTATION** 
    Since the script will use "Google Translate", it can sometimes write the long sentences of the meaning of the word you wrote in a different way. 
]]--
...
--[[
    ...
    Credits:
    GitHub, Sketch-K;
    Discord, denizhan142536748596917364825343 is developing script!
]]--
...
--[[Google Translate embedded into the game]]--
...
local translate, getISOCode do
    function googleConsent(Body) -- Yeah, because google really said: "Fuck you."
        local args = {}
    ...
    local function got(url, Method, Body) -- For SynapseX cuz sometimes SynapseX ask API
...
--[[ **ABRIDGED CODES OF COUNTRIES** ]]--
    ...
    function translate(str, to, from)
        ...
        local url = executeURL..'?'..stringifyQuery{rpcids = rpcidsTranslate, ['f.sid'] = fsid, bl = bl, hl="tr", _reqid = reqid-10000, rt = 'c'}
